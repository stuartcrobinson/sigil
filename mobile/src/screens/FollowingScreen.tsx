...
import { getFollowing, FollowUser } from '../services/socialService';
...
export function FollowingScreen() {
  ...
  const renderUser = ({ item }: { item: FollowUser }) => (
    <TouchableOpacity style={styles.userCard} testID={`following-${item.id}`}>
  ...
  if (error) {
    return (
      <View style={styles.centerContainer}>
        ...
        <TouchableOpacity style={styles.retryButton} onPress={loadFollowing} testID="retry-button">
